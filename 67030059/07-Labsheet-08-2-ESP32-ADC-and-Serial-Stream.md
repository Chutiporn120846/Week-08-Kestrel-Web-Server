...
1. ใน ESP-IDF v6.x ฟังก์ชัน `adc_oneshot_read()` คืนค่าผลลัพธ์เป็นตัวเลขแบบใด และมีช่วงค่าต่ำสุด-สูงสุดเท่าใดเมื่อตั้งค่าเป็น `ADC_BITWIDTH_12`
   - **คำตอบ:ฟังก์ชัน adc_oneshot_read() ใช้อ่านค่า ADC ในรูปแบบตัวเลขจำนวนเต็ม (Integer) โดยเมื่อกำหนดเป็น ADC_BITWIDTH_12 จะมีช่วงค่าตั้งแต่ 0 ถึง 4095 (2¹² - 1)
1. ทำไมเราจึงต้องกดปุ่ม `Ctrl + ]` เพื่อปิด **ESP-IDF Monitor** ก่อนที่เราจะรันโปรแกรมฝั่ง C# Kestrel ในใบงานถัดไป
   *(คำใบ้: หากโปรเซส idf.py monitor ยังเปิดค้างอยู่ จะเกิดอะไรขึ้นกับพอร์ต COM)*
   - **คำตอบ:** ต้องกด Ctrl + ] เพื่อปิด ESP-IDF Monitor เพราะโปรแกรม idf.py monitor กำลัง ใช้งานและล็อกพอร์ต Serial/COM อยู่ หากไม่ปิด พอร์ตอาจถูกโปรแกรม C# Kestrel เปิดใช้งานไม่ได้ เนื่องจากพอร์ต Serial หนึ่งพอร์ตไม่สามารถให้หลายโปรแกรมใช้งานพร้อมกันได้
---
...
![alt text](4k.jpg) 
![alt text](5E286CEE-B1E5-410A-8A07-DACEA177D4E6.jpg) 
![alt text](021E5FFD-58D7-4717-827F-6821753F2B2A.jpg)
![alt text](S__29573125.jpg)