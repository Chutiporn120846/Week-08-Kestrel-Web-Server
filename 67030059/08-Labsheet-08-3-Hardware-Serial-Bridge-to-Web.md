...
2. กด Refresh (F5) บนหน้าเบราว์เซอร์หลายๆ ครั้งติดต่อกัน สังเกตว่า:
   ...
   - **คำตอบ:**
   - มื่อถอดสาย USB ของ ESP32 ระบบจะเปลี่ยน dataSource เป็น Simulation Mode (2 Channels) และค่า rawValue ของทั้ง Channel A และ Channel B ยังคงเปลี่ยนแปลงได้อย่างต่อเนื่อง โดยเป็นค่าที่สร้างจากการจำลองด้วยฟังก์ชันทางคณิตศาสตร์ (Sine/Cosine) ทำให้ค่าขึ้นลงแบบต่อเนื่องแทนข้อมูลจาก ESP32 จริง
---
...
![alt text](D6A13B20-0AC9-434F-B342-44EE27022BB6.jpg)
https://youtube.com/shorts/EKVPhxrRC64?si=2X7COko-zuHIXPp0
